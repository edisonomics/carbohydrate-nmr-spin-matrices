...
%
% Fit the real 600 MHz alanine noesypr1d processed spectrum using the
...
project_dir  = fullfile(repo_dir, 'outputs', 'alanine');
spinach_root = getenv('SPINACH_ROOT');
exp_1r       = fullfile(repo_dir, 'data', 'alanine', '600_MHz', '5', 'pdata', '1', '1r');
...
%% Acquisition settings from cece_data/600_MHz/Alanine/5
SFO1_MHz = 599.764818881;
O1_Hz    = 2818.881;
SW_Hz    = 6000;
TD       = 32768;
ncomplex = TD/2;
...
fprintf('\n===== Alanine 600 MHz noesypr1d experiment fit =====\n');
...
title(tl, sprintf('Alanine 600 MHz noesypr1d fit to experiment | r %.4f, RMSE %.5f', ...
...
function [ppm_axis, y] = read_bruker_1r(path_1r)
    EXP_SF = 599.761956058822;
    EXP_SW_p = 5999.99999999999;
    EXP_OFFSET = 9.775249;
    EXP_NC_proc = -4;
    EXP_BYTORDP = 0;
    EXP_DTYPP = 0;
