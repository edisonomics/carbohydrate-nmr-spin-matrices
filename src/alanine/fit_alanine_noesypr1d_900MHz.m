...
%
% Fit the real 900 MHz alanine noesypr1d processed spectrum using the
...
project_dir  = fullfile(repo_dir, 'outputs', 'alanine', '900MHz');
spinach_root = getenv('SPINACH_ROOT');
exp_1r       = fullfile(repo_dir, 'data', 'alanine', '900_MHz', '7', 'pdata', '1', '1r');
...
%% Acquisition settings from data/alanine/900_MHz/7
SFO1_MHz = 899.794229013;
O1_Hz    = 4229.013;
SW_Hz    = 9090.90909090909;
TD       = 32768;
ncomplex = TD/2;
tmix_s   = 0.05;
...
fprintf('\n===== Alanine 900 MHz noesypr1d experiment fit =====\n');
...
title(tl, sprintf('Alanine 900 MHz noesypr1d fit to experiment | r %.4f, RMSE %.5f', ...
...
function [ppm_axis, y] = read_bruker_1r(path_1r)
    EXP_SF = 899.789938949748;
    EXP_SW_p = 9090.90909090907;
    EXP_OFFSET = 9.81953388830781;
    EXP_NC_proc = 13;
    EXP_BYTORDP = 0;
    EXP_DTYPP = 0;
